...
class FullScreenFeatureOverlay extends StatefulWidget {
  ...
  const FullScreenFeatureOverlay({
    Key? key,
  ...
  @override
  _FullScreenFeatureOverlayState createState() =>
      _FullScreenFeatureOverlayState();
}

class _FullScreenFeatureOverlayState extends State<FullScreenFeatureOverlay>
    with TickerProviderStateMixin {
  static const double kDefaultBackgroundOpacity = 0.0;
  ...
  @override
  void didUpdateWidget(FullScreenFeatureOverlay oldWidget) {
  ...
  Widget _buildOverlay(Offset anchor) {
    ...
    final contentPosition = Offset(
      ...
      anchor.dy +
          ...
          44, // 44 is the tap target's radius.
    );
          ...
          children: <Widget>[
            LayoutId(
              ...
              child: _Background(
                ...
                defaultOpacity: kDefaultBackgroundOpacity,
                state: _state!,
                overflowMode: widget.overflowMode,
