...
class CustomTargetFeatureOverlay extends StatefulWidget {
  static const double kDefaultBackgroundOpacity = 0.96;

  /// This id should be unique among all the [CustomTargetFeatureOverlay] widgets.
  ...
  /// to this [Widget] instead of as the [Key] of [CustomTargetFeatureOverlay].
  ...
  const CustomTargetFeatureOverlay({
    Key? key,
  ...
  @override
  _CustomTargetFeatureOverlayState createState() =>
      _CustomTargetFeatureOverlayState();
}

class _CustomTargetFeatureOverlayState extends State<CustomTargetFeatureOverlay>
  ...
  /// because [CustomTargetFeatureOverlay.onComplete] and [CustomTargetFeatureOverlay.onDismiss]
  ...
  @override
  void didUpdateWidget(CustomTargetFeatureOverlay oldWidget) {
